...
Updated: 2026-08-09T14:51:19.094396+00:00
Memory window: 48 hours

## 1. Modder pumps liquid directly over bare GPU silicon via 3D-printed block — drops RTX 2060 Super load temps to 28°C despite initial leaks - Tom's Hardware
...
## 2. How a small Israeli startup was linked to rogue AI hacks at OpenAI, Anthropic and Meta - CNBC
...
## 3. Samsung Galaxy Z Fold 8 review: The ‘pocket phone’ that actually fits your jeans - The Indian Express
...
## 5. Apple Tests Chinese Memory Chips as Supply Squeeze Bites - WSJ
Source: WSJ (reputable)
...
## 6. Jevon’s Paradox: why China’s cheap AI models could be good for Silicon Valley - South China Morning Post
...
## 7. iPhone 18 Pro launching in few weeks, here are 10 updates Apple likely to introduce - India Today
...
## 8. Apple says Mac users in China can connect to Alibaba’s Qwen AI service - The Indian Express
Source: The Indian Express (reputable)
...
## 9. Profit-linked bonuses at Samsung, SK unlikely to spread across Korean biz - The Korea Times
...
## 10. Firebird Launches CIS Region’s Largest AI Factory in Armenia - NVIDIA Blog
...
## 11. Nvidia RTX 5090 ships in bizarre 8-motherboard bundle — retailers hold GPUs hostage similar to the crypto boom - Tom's Hardware
Source: Tom's Hardware (reputable)
...
## 12. Lifetime access to Claude, GPT, Gemini, and 17+ other AI models is $60 with this promo code - Mashable
...
## 13. OpenAI to pause some work on AI model Astra due to security concerns | AI (artificial intelligence) - The Guardian
...
## 14. OpenAI to pause some work on AI model Astra due to security concerns - The Guardian
Source: The Guardian (reputable)
URL: https://news.google.com/rss/articles/CBMiiAFBVV95cUxPY1dJNXVXYnpmS0U2OFQtSDhFcURicFNyMGFMVGVjdTAtQWJmc21hcUU3dGJaNnBMeVMySHVhTGZmRF9xUko1c2JJS3haRjlTaWtVV3QtelExODdVTGtfNThUb0RrS2JFN3pqWEJoUkkwSHpoSWJaemNFam1zbXFwUkJnbFRjRFZV?oc=5

OpenAI to pause some work on AI model Astra due to security concerns The Guardian

## 15. OpenAI to pause work on AI model Astra due to security concerns - The Guardian
Source: The Guardian (reputable)
URL: https://news.google.com/rss/articles/CBMiiAFBVV95cUxPY1dJNXVXYnpmS0U2OFQtSDhFcURicFNyMGFMVGVjdTAtQWJmc21hcUU3dGJaNnBMeVMySHVhTGZmRF9xUko1c2JJS3haRjlTaWtVV3QtelExODdVTGtfNThUb0RrS2JFN3pqWEJoUkkwSHpoSWJaemNFam1zbXFwUkJnbFRjRFZV?oc=5

OpenAI to pause work on AI model Astra due to security concerns The Guardian

## 16. OpenAI Astra: The mysterious new quantum math-solving model - Mashable
Source: Mashable (reputable)
...
## 17. Exclusive: OpenAI slows release of Astra model citing cyber capabilities - Axios
...
## 18. Apple says Mac users in China can connect to Alibaba's Qwen AI service - Reuters
...
## 19. Arena AI CEO Says Enterprises Don't Know Which AI Models to Trust - Business Insider
...
## 20. Amazon is giving away $100 gift cards with the Samsung Galaxy Watch Ultra 2 — offer ends tonight - Mashable
Source: Mashable (reputable)
...
## 21. Sam Altman says Astra model is so powerful, OpenAI can't launch it now - India Today
Source: India Today (reputable)
...
## 22. OpenAI strengthens security controls as upcoming Astra AI model nears critical cyber threshold - Moneycontrol.com
...
## 23. Samsung Galaxy Z series foldables are breaking pre-order records in the US and Korea - Mashable
Source: Mashable (reputable)
...
## 24. OpenAI takes Apple lawsuit to court of public opinion, posts texts - Mashable
Source: Mashable (reputable)
...
## 25. Thailand looks to Siam Silica to propel it to top Asean semiconductor player - South China Morning Post
Source: South China Morning Post (reputable)
...
## 26. Nvidia to invest up to $3 billion in Lancium, the Information reports - Reuters
Source: Reuters (reputable)
...
## 27. OpenAI flags possible critical cybersecurity risk in upcoming model, tightens controls - Reuters
Source: Reuters (reputable)
...
## 28. OpenAI says it slowed Astra model development over security concerns - TechCrunch
...
## 29. OpenAI Pauses Some Work on New AI Model Over Cybersecurity Concerns - WSJ
Source: WSJ (reputable)
